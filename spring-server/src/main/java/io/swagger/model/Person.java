...
import io.swagger.model.SpokenLanguages;
...
@Pattern(regexp="[a-z0-9]{8,64}") @Size(min=8,max=64) 
  ...
  **/
  ...
  public Person avatarBase64PNG(byte[] avatarBase64PNG) {
...
@Pattern(regexp="^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$") 
  public byte[] getAvatarBase64PNG() {
    return avatarBase64PNG;
  }

  public void setAvatarBase64PNG(byte[] avatarBase64PNG) {
    this.avatarBase64PNG = avatarBase64PNG;
  }

  public Person spokenLanguages(SpokenLanguages spokenLanguages) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, username, dateOfBirth, lastTimeOnline, avatarBase64PNG, spokenLanguages);
  }
